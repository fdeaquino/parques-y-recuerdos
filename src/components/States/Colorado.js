    ...
    return (
        <section className={`${className}`} id="colorado" ref={coloradoRef}>
            <div className='state-section bg-light p-3'>
                ...
                {t('colorado.stateName')}
                    </h3>
                <p className='intro-paragraph'>
                {t('colorado.introForState')}
                    </p>
            </div>
            <div className='park-section bg-light p-3' ref={rockyMountainsRef} >
                <h4 className='intro-subtitle park-title'>
                {t('colorado.parkNameForRockyMountains')}
                    </h4>
                <p className='intro-paragraph'>
                {t('colorado.introForRockyMountains')}
                    </p>
            ...
            <div className='park-section bg-light p-3' ref={mesaVerdeRef}>
                <h4 className='intro-subtitle park-title'>
                {t('colorado.parkNameForMesaVerde')}
                    </h4>
                <p className='intro-paragraph'>
                {t('colorado.introForMesaVerde')}
                    </p>
                {/* Grid and photos go here */}
                <div className='grid'>
                    <div className='box box--3x3'>
            ...
            <div className='park-section bg-light p-3' ref={gardenOfTheGodsRef}>
                <h4 className='intro-subtitle park-title'>
                {t('colorado.parkNameForGardenOfTheGods')}
                    </h4>
                <p className='intro-paragraph'>
                {t('colorado.introForGardenOfTheGods')}
                    </p>
                {/* Grid and photos go here */}
                <div className='grid'>
                    <div className='box box--3x3'>
            ...
            <div className='park-section last-park bg-light p-3' ref={redRocksRef}>
                <h4 className='intro-subtitle park-title'>
                {t('colorado.parkNameForRedRocks')}
                    </h4>
                <p className='intro-paragraph'>
                {t('colorado.introForRedRocks')}
                    </p>
                {/* Grid and photos go here */}
                <div className='grid'>
                    <div className='box box--3x3'>
