...
function NewMexicoContent({ className }) {
    const ref = useRef();
    ...
    return (
        <section className={`bg-light p-3 m-3 ${className}`} id="newmexico" ref={ref}>
            <h3 className='intro-subtitle'>NEW MEXICO Title Goes Here</h3>
