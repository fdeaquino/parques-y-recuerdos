...
function NewYorkContent({ className }) {
    const ref = useRef();
    ...
    return (
        <section className={`bg-light p-3 m-3 ${className}`} id="newyork" ref={ref}>
            <h3 className='intro-subtitle'>NEW YORK Title Goes Here</h3>
