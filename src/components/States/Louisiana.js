...
function LouisianaContent({ className }) {
    const ref = useRef();
    ...
    return (
        <section className={`bg-light p-3 m-3 ${className}`} id="louisiana" ref={ref}>
            <h3 className='intro-subtitle'>LOUISIANA Title Goes Here</h3>
